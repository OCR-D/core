...
from ocrd.model_factory import exif_from_filename

# pylint: disable=no-member
class TestOcrdExif(TestCase):

    def test_tiff(self):
        exif = exif_from_filename(assets.path_to('SBB0000F29300010000/data/OCR-D-IMG/FILE_0001_IMAGE'))
    ...
    def test_png1(self):
        exif = exif_from_filename(assets.path_to('kant_aufklaerung_1784-binarized/data/OCR-D-IMG-BIN/BIN_0020'))
    ...
    def test_png2(self):
        exif = exif_from_filename(assets.path_to('scribo-test/data/OCR-D-IMG-BIN-SAUVOLA/OCR-D-IMG-orig_sauvola_png'))
    ...
    def test_jpg(self):
        exif = exif_from_filename(assets.path_to('leptonica_samples/data/OCR-D-IMG/OCR-D-IMG_1555_007'))
    ...
    def test_jp2(self):
        exif = exif_from_filename(assets.path_to('kant_aufklaerung_1784-jp2/data/OCR-D-IMG/INPUT_0020'))
        self.assertEqual(exif.width, 1457)
        self.assertEqual(exif.height, 2084)
        self.assertEqual(exif.xResolution, 1)
        self.assertEqual(exif.yResolution, 1)
